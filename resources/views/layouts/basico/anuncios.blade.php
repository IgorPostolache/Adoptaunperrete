...
<link rel="stylesheet" href="{{ asset('css/verMisAnuncios.css') }}">
<p>*** Para ver un anuncio pulsa sobre su nombre <i class="fa fa-eye" aria-hidden="true"></i></p> 
<div class="table-responsive">
		...
		<table class="table table-bordered table-condensed table-striped table-hover">
			...
			<tbody>
				@forEach($anuncios as $anuncio)
					<tr>
						<td>
							<a href="anuncios/{{$anuncio->id}}" class="nombre">
								{{$anuncio->nombre}} 
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
						</td>
						<td>
							<a href="/anuncios/{{$anuncio->id}}/edit" class="btn btn-editar">
								Editar
	...
	@else
		<p>No has creado todavía ningún anuncio</p>
	@endif
	{{ $anuncios->links() }} 
	<a href="/anuncios/create" class="btn btn-borrar" id="publicar">Publicar nuevo anuncio</a>
</div>
@endsection
